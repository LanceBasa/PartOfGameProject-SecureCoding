...
int main() {
  ...
  struct ItemDetails items001_expectedItems_test2[] = {
      {.itemID = 16602759796824695000UL,
       .name = "telescope",
       .desc = "brass with wooden tripod, 25x30x60 in."},
      {.itemID = 13744653742375254000UL,
       .name = "rope",
       .desc = "hemp, 50 ft."},
      {.itemID = 3400701144194139000UL,
       .name = "music-box",
       .desc = "brass gears with tin-plated case, 6 in., cursed"},
      {.itemID = 734628920708863200UL,
       .name = "billiard-ball",
       .desc = "ivory, 2 in., set of 16 in wooden case, of mysterious origin"},
      {.itemID = 14734865628490349000UL,
       .name = "sword-cane",
       .desc = "steel-bladed, concealed in Malacca-wood walking-cane, 36 in."},
      {.itemID = 14324391740292973000UL,
       .name = "dynamite-stick",
       .desc = "with paper wrapping, 1 in. diameter x 12 in."},
      {.itemID = 7562791295545618000UL,
       .name = "Epsom-salts",
       .desc = "6 oz, in glass bottle with cork stopper"},
      {.itemID = 13658877949582529000UL,
       .name = "camp-stool",
       .desc = "canvas and wood, 12 in. seat height"},
      {.itemID = 2390949174291477500UL,
       .name = "slide-rule",
       .desc = "wood and brass, 12 in., cursed"},
  };

  size_t items001_expectedSize_test2 =
      sizeof(items001_expectedItems_test2) / sizeof(struct ItemDetails);
  ...
  struct Character arr[] = {
      ...
      {.characterID = 2,
       ...
       .name = "Sarah Smith",
       .inventorySize = 2,
       .inventory = {{.itemID = 123456789, .quantity = 3},
                     {.itemID = 987654321, .quantity = 2}}},
      {.characterID = 3,
       .socialClass = ARISTOCRACY,
       .profession = "noble",
       .name = "Lord William",
       .inventorySize = 3, // No inventory
       .inventory = {{.itemID = 111222333, .quantity = 5},
                     {.itemID = 444555666, .quantity = 1},
                     {.itemID = 777888999, .quantity = 4}}},
      {.characterID = 4,
      ...
      {.characterID = 5,
       ...
       .name = "Henry Smithson",
       .inventorySize = 2,
       .inventory = {{.itemID = 987654321, .quantity = 2},
                     {.itemID = 222333444, .quantity = 1}}}};

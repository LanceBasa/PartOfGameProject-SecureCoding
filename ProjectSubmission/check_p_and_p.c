...
int main(void)
{
    ...
    TCase *tc1_2 = tcase_create("loadItemDetails_items001_works_testcase");
    TCase *tc1_3 = tcase_create("isValidName_testcase");
    TCase *tc1_4 = tcase_create("saveItemDetails_testcase");
    ...
    tcase_add_test(tc1_2, loadItemDetails_items001_size_is_correct);
    tcase_add_loop_test(tc1_2, loadItemDetails_items001_items_are_equal, 0, 9);
    suite_add_tcase(s1, tc1_3);
    tcase_add_test(tc1_3, isValidName_simple_case);
    tcase_add_loop_test(tc1_3, isValidName_more_cases, 0, 3);
    suite_add_tcase(s1, tc1_4);
    tcase_add_test(tc1_4, saveItemDetails_works);

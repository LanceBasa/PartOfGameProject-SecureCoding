...
/**
 * This function validates the data, opens the incomming file descriptor for
 * writing and writes the data to the file. It returns 0 on success and 1 on
 * failure.
 *
 ...
 * and stores it in the provided pointer. It returns 0 on success and 1 on
 * failure.
 *
